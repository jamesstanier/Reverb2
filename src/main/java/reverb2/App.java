...
public class App {
	...
	private void setup() {
		...
		Reverb2.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		...
		//This button is to stop Audio playback.
	    ...
	    checkBox.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
               if (audio != null) {
				audio.bLoop = (e.getStateChange()==1?true:false);
			   }
            }
         });
		...
		sliderRD1 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 100);
		...
		sliderRD2 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 160);
		...
		sliderRD3 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 220);
		...
		sliderRD4 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 280);
		...
		sliderVD1 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 100);
		sliderVD1.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent arg0) {
				...
				lblDelayVD1_value.setText(Integer.toString(sliderVD1.getValue()) + " µs");
			}
		});
		...
		sliderVD2 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 160);
		sliderVD2.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent arg0) {
				...
				lblDelayVD2_value.setText(Integer.toString(sliderVD2.getValue()) + " µs");
			}
		});
		...
		sliderVD3 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 220);
		sliderVD3.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent arg0) {
				...
				lblDelayVD3_value.setText(Integer.toString(sliderVD3.getValue()) + " µs");
			}
		});
		...
		sliderVD4 = new JSlider(SwingConstants.HORIZONTAL, 0, 500, 280);
		sliderVD4.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent arg0) {
				...
				lblDelayVD4_value.setText(Integer.toString(sliderVD4.getValue()) + " µs");
			}
		});
		...
		sliderGR = new JSlider(SwingConstants.HORIZONTAL, 0, 99, 70);
		...
		sliderGV = new JSlider(SwingConstants.HORIZONTAL, 0, 99, 70);
		...
		JLabel lblCredits = new JLabel("<html>Created by James Stanier 2025<br/>(with help from Rishikesh Daoo)<html>");
		...
		lblDelayVD1_value = new JLabel(Integer.toString(sliderVD1.getValue()) + " µs");
		...
		lblDelayVD2_value = new JLabel(Integer.toString(sliderVD2.getValue()) + " µs");
		...
		lblDelayVD3_value = new JLabel(Integer.toString(sliderVD3.getValue()) + " µs");
		...
		lblDelayVD4_value = new JLabel(Integer.toString(sliderVD4.getValue()) + " µs");
